...
<div id="page" class="<?php echo $sectionClass ?>">
  ...
  <div id="header">
    ...
    <p id="navigation"><a id="pianina<?php echo "-".$lang ?>"<?php if(get('category')=="pianina") echo ' class="active"';?> href="produkty/pianina/" title="Piana, pianina">Pianina<span></span></a><span class="hidden"> | </span><a id="klaviry<?php echo "-".$lang ?>"<?php if(get('category')=="klaviry") echo ' class="active"';?> href="produkty/klaviry/" title="Klavíry, koncertní křídla, cembala">Klavír, klavíry<span></span></a></p>
    <?php echo $sectionClass; if ($sectionClass!="detail-pianina") { ?>
    <div id="steinway">
    	<p style="font-weight: bold">Výhradní dovozce značek Steinway&Sons, Boston a Essex pro Českou a Slovenskou republiku</p>
        <p>
        ...
        <br style="clear: both" />
        <p></p>
        <p class="red bold">V brzké době budeme otvírat nový obchod v Bratislavě.</p>
    </div>
    <p id="manufacturers">
    <?php } else { ?>
...
//        $langURLDE = "/de/".$langURL;
        ...
        ?>
        <a id="cs" class="active" href="<?php echo $langURLCZ;?>" title="Česká verze">CZ<span></span></a> |
